    ...
    return (
        <div>
            <TextField
                ...
                label={T.translate("vehicles.metadata.createdBy")}
                id="createdBy"
                name="createdBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicles.metadata.createdAt")}
                id="createdAt"
                name="createdAt"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicles.metadata.updatedBy")}
                id="updatedBy"
                name="updatedBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicles.metadata.updatedAt")}
                id="updatedAt"
                name="updatedAt"
